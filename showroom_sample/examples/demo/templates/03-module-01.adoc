...
* Practice with OpenShift examples — deploy an application in one command:
+
[source,role="execute"]
----
...
* Then show automatic scaling — this would normally take weeks to configure manually:
+
[source,role="execute"]
----
oc autoscale deployment/nodejs-ex --min=1 --max=5 --cpu-percent=80
oc get hpa nodejs-ex
----
...
[source,asciidoc]
----
image::tekton-dev-1.png[link=self,window=blank,align="center",width=500]
----
